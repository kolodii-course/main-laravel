								...
								<div class="bg-white px-4 py-5 sm:p-6">
									<div>
										<div>
											...
											<input value="{{ old('title', $post->title) }}" type="text" name="title" id="title" class="mt-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
										</div>
									...
									<div class="mt-10">
										...
										<textarea name="text"
											  ...
											  id="description"
											  cols="30"
											  rows="10">{{ old('text', $post->text) }}</textarea>
									</div>
